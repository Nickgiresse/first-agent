...
public final class StagingOcrResult {
    ...
    public static StagingOcrResult creer(
            OnboardingSessionId onboardingSessionId,
            String documentKind,
            String firstName,
            String lastName,
    ...
    public static StagingOcrResult reconstituer(
            OcrResultId id,
            OnboardingSessionId onboardingSessionId,
            String documentKind,
            String firstName,
