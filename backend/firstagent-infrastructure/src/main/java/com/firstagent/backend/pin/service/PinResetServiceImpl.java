...
public class PinResetServiceImpl implements PinResetService {
  ...
  public PinResetResponse requestReset(PinResetRequest request) {
    Customer customer =
        customerRepository
            .findByBankAccount_AccountNumber(request.getAccountNumber())
    ...
    if (customer.getEmail() == null) {
      return PinResetResponse.builder()
          ...
          .message(
              "Aucun email n'est associé à ce compte. Veuillez vous rendre en agence pour réinitialiser votre PIN.")
          .build();
    }
