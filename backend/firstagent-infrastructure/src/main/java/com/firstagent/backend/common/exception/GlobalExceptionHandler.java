...
public class GlobalExceptionHandler {
     ...
     *
     * <p>C'est ici, et nulle part ailleurs, que le refus métier devient un code
     * de transport. Le domaine ignore volontairement cette correspondance : ses
     * exceptions portent un {@link TypeErreurMetier}, ce qui lui permet de
     * rester sans dépendance à Spring (charte §3). La table suit celle de la
     * charte §6.
     *
     * <p>REGLE_METIER donne 422 et non 400 : la requête est bien formée, c'est
     * la règle de gestion qui refuse. La distinction compte pour l'appelant,
     * qui doit corriger sa donnée dans un cas et renoncer dans l'autre.
     */
    private static final Map<TypeErreurMetier, HttpStatus> STATUTS = Map.of(
