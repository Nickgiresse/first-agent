...
/**
 * Comparaison tolérante de chaînes (noms, prénoms) utilisée pour rapprocher les données extraites
 * d'une CNI de valeurs saisies ou de référence, en absorbant les différences d'accents, de casse et
 * les petites fautes de frappe.
 */
public final class StringSimilarity {
  ...
  /**
   * Retourne un score de similarité entre 0.0 (aucun rapport) et 1.0 (identique) basé sur la
   * distance de Levenshtein normalisée, après normalisation des deux valeurs.
   */
  ...
  public static String normalize(String value) {
    ...
    String withoutDiacritics =
        DIACRITICS.matcher(Normalizer.normalize(value, Normalizer.Form.NFD)).replaceAll("");
