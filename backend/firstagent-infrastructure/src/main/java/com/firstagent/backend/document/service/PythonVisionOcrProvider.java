...
/**
 * Implémentation de {@link OcrProvider} appelant le microservice Python (Modules 1 et 2 : qualité
 * du document puis extraction OCR structurée CNI/titre provisoire). Remplace Mindee.
 */
@Service
